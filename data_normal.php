...
<ul class="pagination justify-content-center">
    ...
    ?>
        <li  class="page-item"><a class="page-link" href="data_normal.php?page=1">First</a></li>
        <li  class="page-item"><a class="page-link" href="data_normal.php?page=<?php echo $link_prev; ?>">&laquo;</a></li>
    <?php
    }
    ?>
    ...
    ?>
        <li  class="page-item" <?php echo $link_active; ?>><a class="page-link" href="data_normal.php?page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
    <?php
    }
    ?>
    ...
    ?>
        <li><a class="page-link"  href="data_normal.php?page=<?php echo $link_next; ?>">&raquo;</a></li>
        <li><a class="page-link"  href="data_normal.php?page=<?php echo $jumlah_page; ?>">Last</a></li>
    <?php
    }
    ?>
</ul>
