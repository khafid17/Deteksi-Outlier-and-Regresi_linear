...
$res = mysqli_query($con, "SELECT id, nama, score_3, score_overall FROM data_author_score_500 UNION ALL SELECT id, nama, score_3, score_overall FROM tbl_info ORDER BY score_3 ASC");
