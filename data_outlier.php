        ...
        <table class="table table-striped">
            <thead class="thead-dark">
                <tr>
                    ...
                    <th scope="col">Nilai Y Hasil Regresi</th>
            ...
            <tbody>
              ...
              <?php
            //   $tabel="data_regresi";
            //   $sql1="SELECT count(hasil) as jumlah from data_regresi where hasil > 12.36842939";
            //   $query1 = mysql_query($sql1);
            //   $result = mysql_fatch_row($query1);
            //   echo "jumla data outlier adalah : {$result['jumlah']}<br/>";
                  ...
                  $tampil = "SELECT nama,score_overall,regresi FROM data_regresi where hasil > 39.10675197 ORDER BY hasil DESC limit $limit OFFSET " . $limit_start;
...
<ul class="pagination justify-content-center">
    ...
    ?>
        <li  class="page-item"><a class="page-link" href="data_outlier.php?page=1">First</a></li>
        <li  class="page-item"><a class="page-link" href="data_outlier.php?page=<?php echo $link_prev; ?>">&laquo;</a></li>
    <?php
    }
    ?>
    ...
    ?>
        <li  class="page-item" <?php echo $link_active; ?>><a class="page-link" href="data_outlier.php?page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
    <?php
    }
    ?>
    ...
    ?>
        <li><a class="page-link"  href="data_outlier.php?page=<?php echo $link_next; ?>">&raquo;</a></li>
        <li><a class="page-link"  href="data_outlier.php?page=<?php echo $jumlah_page; ?>">Last</a></li>
    <?php
    }
    ?>
</ul>
